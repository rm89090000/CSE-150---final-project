...
class Final (object):
  ...
  def do_final (self, packet, packet_in, port_on_switch, switch_id):
    ...
    dest = str(ips.dstip)
    floor1_hosts =["128.114.1.101", "128.114.1.102", "128.114.1.103", "128.114.1.104"]
    floor2_hosts =["128.114.2.201", "128.114.2.202", "128.114.2.203", "128.114.2.204"]
    #untrusted host
    ...
    if switch_id == 1:
      ...
      if dest == "128.114.3.178":
        output = 2
      elif dest in floor1_hosts or dest in floor2_hosts or dest == "192.47.38.109" or dest == "108.35.24.113":
        output = 1
